      ...
      <Card.Body>
        <blockquote className="blockquote mb-0">
          <p style={{ textAlign: "justify" }}>
            Hi Everyone, I am <span className="purple">Kaustubh Pathak </span>
            from <span className="purple"> Gorakhpur, India.</span>
            <br /> I am a final year student pursuing a Bachelor of Technology in Electronics and Communication at MMMUT Gorakhpur.
            <br />
